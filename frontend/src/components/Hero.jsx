                ...
                <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 hero-fade-in-delay">
                    <a
                      ...
                      className="bg-red-600 text-white px-8 py-3 rounded-lg font-medium text-lg shadow-lg hover:bg-red-700 transition-all transform hover:scale-105 inline-flex items-center justify-center"
                    >
